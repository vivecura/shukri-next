      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 pt-14 pb-10">
        ...
        <div className="mt-14 pt-6 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href={localizedAnchor("/rechtliches#impressum")} className="text-[#515757]/30 text-xs hover:text-[#515757]/60 transition-colors no-underline">
              {t("footer.impressum")}
            </Link>
            <Link href={localizedAnchor("/rechtliches#datenschutz")} className="text-[#515757]/30 text-xs hover:text-[#515757]/60 transition-colors no-underline">
