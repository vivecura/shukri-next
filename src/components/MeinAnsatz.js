...
export default function MeinAnsatz() {
  ...
  const items = dict?.meinAnsatz?.items || DICTS.de.meinAnsatz.items;
  const circleLabels = dict?.meinAnsatz?.circleLabels || DICTS.de.meinAnsatz.circleLabels;
  const headerSuffix = dict?.meinAnsatz?.headerTitleSuffix ?? "";
