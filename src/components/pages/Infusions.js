...
function ShotsSection() {
  ...
  const shotsDict = dict?.infusions?.shots || DICTS.de.infusions.shots;
  ...
  const shots = [
    {
      ...
      oldPrice: "40 €",
      price: "25 €",
      desc: shotsDict.vitaminD?.desc,
      tags: shotsDict.vitaminD?.tags || [],
      popupDesc: shotsDict.vitaminD?.popupDesc,
      ingredients: "Vitamin D3 100.000 IU (Cholecalciferol)",
      whyTitle: shotsDict.vitaminD?.whyTitle,
      whyText: shotsDict.vitaminD?.whyText,
    },
    {
      ...
      duration: "15 min.",
      price: "ca. 39 €",
      desc: shotsDict.magnesium?.desc,
      tags: shotsDict.magnesium?.tags || [],
      popupDesc: shotsDict.magnesium?.popupDesc,
      ingredients: "Magnesium 6mmol (i.v.)",
      whyTitle: shotsDict.magnesium?.whyTitle,
      whyText: shotsDict.magnesium?.whyText,
    },
    {
      ...
      duration: "15 min.",
      price: "45 €",
      desc: shotsDict.glutathion?.desc,
      tags: shotsDict.glutathion?.tags || [],
      popupDesc: shotsDict.glutathion?.popupDesc,
      ingredients: "Reduziertes Glutathion 1.800 mg (L-Glutathion)",
      whyTitle: shotsDict.glutathion?.whyTitle,
      whyText: shotsDict.glutathion?.whyText,
    },
  ];
          ...
          {shots.map((shot, i) => (
            ...
            >
              ...
              <div className="flex flex-col flex-1 px-4 pt-3 pb-4">
                <h3 className="font-semibold text-base text-[#515757]">
                  {shot.title}
                </h3>
                ...
                <p className="text-xs text-[#515757]/60 mt-2 leading-relaxed flex-1">
                  {shot.desc}
                </p>
                <div className="flex items-center gap-2 mt-3">
                  {shot.oldPrice && (
                    <span className="text-sm text-[#515757]/40 line-through">
                      {shot.oldPrice}
                    </span>
                  )}
                  <span className="text-lg font-bold text-[#515757]">
                    {shot.price}
                  </span>
                </div>
              </div>
          ...
          >
            ...
            <div className="overflow-y-auto flex-1">
              <div className="w-full h-48 overflow-hidden">
                <img
                  src={shots[expandedShot].img}
                  alt={shots[expandedShot].title}
                  className="w-full h-full object-cover"
                />
              </div>

              <div className="px-6 pt-5 pb-4">
                <h2 className="font-bold text-xl text-[#515757]">
                  {shots[expandedShot].title}
                </h2>
                <p className="mt-3 text-sm text-[#515757]/70 leading-relaxed">
                  {shots[expandedShot].popupDesc}
                </p>
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  {shots[expandedShot].tags.map((tag, i) => (
                    <span
                      key={i}
                      className="text-xs font-medium text-[#43a9ab] bg-[#43a9ab]/10 px-3 py-1.5 rounded-full"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="mb-5">
                  <h3 className="text-sm font-bold text-[#515757] mb-1">
                    {t("infusions.ingredients")}
                  </h3>
                  <p className="text-sm text-[#515757]/60 leading-relaxed">
                    {shots[expandedShot].ingredients}
                  </p>
                </div>

                {shots[expandedShot].whyTitle && (
                  <div>
                    <h3 className="text-sm font-bold text-[#515757] mb-2">
                      {shots[expandedShot].whyTitle}
                    </h3>
                    <p className="text-sm text-[#515757]/60 leading-relaxed whitespace-pre-line">
                      {shots[expandedShot].whyText}
                    </p>
                  </div>
                )}
              </div>
            ...
            <div className="px-6 py-4 border-t border-[#515757]/10 flex items-center gap-3">
              <div className="flex items-center gap-2">
                {shots[expandedShot].oldPrice && (
                  <span className="text-sm text-[#515757]/40 line-through">
                    {shots[expandedShot].oldPrice}
                  </span>
                )}
                <span className="text-xl font-bold text-[#515757]">
                  {shots[expandedShot].price}
                </span>
              </div>
