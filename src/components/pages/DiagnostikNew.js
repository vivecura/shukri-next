...
const CONTENT = {
  de: {
    ...
    packages: [
      ...
      { name: "Genetik & Epigenetik", price: "auf Anfrage", icon: IC.dna, forwho: "Wenn Sie wissen wollen, wo Ihre Anlagen liegen und wie Ihr Lebensstil sie beeinflusst.", benefit: "Ihre Gene zeigen das Potenzial, Ihr Lebensstil entscheidet über die Umsetzung. Für Strategien, die wirklich zu Ihnen passen.", markers: ["Genetische Veranlagung", "Epigenetik", "Personalisierte Strategie"] },
    ],
  },
  ...
  en: {
    ...
    packages: [
      ...
      { name: "Genetics & epigenetics", price: "on request", icon: IC.dna, forwho: "If you want to know where your predispositions lie and how your lifestyle influences them.", benefit: "Your genes show the potential, your lifestyle decides the outcome. For strategies that truly fit you.", markers: ["Genetic predisposition", "Epigenetics", "Personalised strategy"] },
    ],
  },
};
