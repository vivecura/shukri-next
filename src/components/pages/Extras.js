...
function KetaminHero() {
  ...
  const sublines = DICTS[lang]?.extras?.sublines || DICTS.de.extras.sublines;
  const whyUs = DICTS[lang]?.extras?.whyUs || DICTS.de.extras.whyUs;
...
function KetaminFAQ() {
  ...
  const faqItems = DICTS[lang]?.extras?.faqItems || DICTS.de.extras.faqItems;
  return (
...
function Extras() {
  ...
  const warumChaptersTranslated =
    DICTS[lang]?.extras?.warumChapters || DICTS.de.extras.warumChapters;
  const warumChapters = [
    {
  ...
  const schemaFaq = DICTS[lang]?.extras?.schemaFaq || DICTS.de.extras.schemaFaq;
  const faqJsonLd = {
