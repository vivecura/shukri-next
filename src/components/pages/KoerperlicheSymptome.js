    ...
    <section className="relative w-full overflow-hidden" style={{ minHeight: "85vh" }}>
      ...
      >
        <div className="max-w-4xl mx-auto w-full">
          ...
          <p className="text-white/80 text-lg sm:text-xl leading-relaxed mb-8 max-w-2xl">{subtitle}</p>
...
const includesIcons = {
  ...
  leaf: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-6 h-6">
      <path
        d="M17 8C8 10 5.9 16.17 3.82 21.34M5 19l2-2M3 7c3.6-1.4 8-1 11 2 3 3 3.4 7.4 2 11"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </svg>
...
function KoerperlicheSymptome() {
  ...
  const ks = dict?.koerperlicheSymptome || DICTS.de.koerperlicheSymptome;

  const recognizeItems = ks.recognizeItems;
  const includesItems = ks.includesItems;
  const therapies = ks.therapies;
  const fitItems = ks.fitItems;
  const faqData = ks.faq;
  const trustItems = ks.trustItems;
      ...
      <section ref={perspectiveAnim.ref} style={perspectiveAnim.style} className="py-16 sm:py-24 px-5 sm:px-8">
        <div className="max-w-4xl mx-auto">
          <div
            ...
            style={{
              background: "linear-gradient(135deg, rgba(67,169,171,0.06) 0%, rgba(67,169,171,0.02) 100%)",
            }}
          >
            <div className="text-[10px] font-light tracking-[3px] uppercase text-[#43a9ab]/60 mb-4">
              {t("koerperlicheSymptome.perspectiveLabel")}
            </div>
            <h3 className="text-xl sm:text-2xl font-bold text-[#43A9AB] mb-6">
              {t("koerperlicheSymptome.perspectiveTitle")}
            </h3>
      ...
      <section ref={fitAnim.ref} style={fitAnim.style} className="py-16 sm:py-24 px-5 sm:px-8">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#43A9AB] mb-8 tracking-tight">
            {t("koerperlicheSymptome.fitTitle")}
          </h2>
      ...
      <section ref={faqAnim.ref} style={faqAnim.style} className="py-16 sm:py-24 px-5 sm:px-8">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#43A9AB] mb-10 tracking-tight">
            {t("koerperlicheSymptome.faqTitle")}
          </h2>
