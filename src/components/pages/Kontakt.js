...
export default function Kontakt() {
  ...
  const anliegenLabels = dict?.kontakt?.step2?.options || [];
  const dauerLabels = dict?.kontakt?.step3?.dauerOptions || [];
          ...
          <div className="vc-form-card mx-auto">
            <div className="vc-form">
              <div className="vc-success">
                ...
                <h2>{interpolate(t("kontakt.successHeading"), { name: data.vorname })}</h2>
          ...
          <form className="vc-form" onSubmit={handleSubmit} noValidate>
            <div className="vc-progress" role="progressbar" aria-valuemin={1} aria-valuemax={TOTAL_STEPS} aria-valuenow={step}>
              ...
              <span className="vc-progress__label">
                {interpolate(t("kontakt.progressLabel"), { current: step, total: TOTAL_STEPS })}
              </span>
            </div>
            ...
            {step === 3 && (
              <fieldset className="vc-step">
                ...
                <div className="vc-counter">
                  {interpolate(t("kontakt.step3.counter"), { count: data.situation.length })}
                </div>
