...
function HealthCheck() {
  ...
  const focusDict = dict?.healthCheck?.focus || {};
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="pt-20 sm:pt-28">
        ...
        <ScrollVideoExperience steps={steps} isMobile={isMobile} />
      </section>
