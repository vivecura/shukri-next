...
function AccordionItem({ title, children, isOpen, onToggle }) {
  return (
    <div className="border-b border-[#43a9ab]/10">
      <button
        onClick={onToggle}
        className="w-full flex items-center justify-between py-6 px-1 text-left focus:outline-none group"
      >
        <span className="text-base sm:text-lg font-medium text-[#515757] group-hover:text-[#43a9ab] transition-colors pr-4">
          {title}
        </span>
        <span className="text-[#43a9ab]">
      ...
      >
        <div className="px-1 text-[#515757]/70 text-sm sm:text-base leading-relaxed">
          {children}
        </div>
      </div>
    </div>
    ...
    <section className="relative w-full overflow-hidden" style={{ minHeight: "85vh" }}>
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(0,0,0,0.15) 0%, rgba(0,0,0,0.50) 55%, rgba(0,0,0,0.40) 75%, rgba(255,255,255,0.3) 90%, rgba(255,255,255,1) 100%)",
          }}
        />
      </div>

      <div
        className="relative z-10 flex flex-col justify-end px-5 sm:px-8 pt-24 pb-12 sm:pb-16"
      ...
      >
        ...
        >
          ...
          >
            ...
            `}</style>
            <svg
              className="w-6 h-6 text-white/50 scroll-glimmer-long"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
...
function PraeventionLongevity() {
  ...
  const pl = dict?.praeventionLongevity || DICTS.de.praeventionLongevity;

  const mentoringCardsTranslated = pl.mentoringCards;
  const processSteps = pl.processSteps;
  const faqData = pl.faq;
  const hebelData = pl.hebel;
  const diagnostikItems = pl.diagnostikItems;
  const startSteps = pl.startSteps;
  const fitItems = pl.fitItems;
  const trustItems = pl.heroTrustItems;

  const mentoringCards = [
    {
      image:
        "/Assets/Images%20Umsetzung%2011%20Mentoring/Stoffwechsel%20stabilisieren.png",
    ...
    {
      image:
        "/Assets/Images%20Umsetzung%2011%20Mentoring/Nervensystem%20regulieren.png",
    ...
    {
      image:
        "/Assets/Images%20Umsetzung%2011%20Mentoring/Immunsystem%20entlasten.png",
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <HeroBanner
        ...
        title={
          <>
            {t("praeventionLongevity.heroTitlePart1")}{" "}
            <em className="italic">{t("praeventionLongevity.heroTitleEm")}</em>
          </>
        }
      ...
      <section
        ref={biofeedbackAnim.ref}
        style={biofeedbackAnim.style}
        className="py-16 sm:py-24 px-5 sm:px-8"
      >
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#43A9AB] mb-6 tracking-tight">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div
              className="rounded-2xl border border-[#43a9ab]/15 p-6 sm:p-8"
            ...
            >
              ...
              <h4 className="text-[#515757] text-lg font-semibold mb-2">
                {t("praeventionLongevity.hrvTitle")}
              </h4>
              <p className="text-[#515757]/60 text-sm leading-relaxed">
                {t("praeventionLongevity.hrvDesc")}
              </p>
            </div>
            <div
              className="rounded-2xl border border-[#43a9ab]/15 p-6 sm:p-8"
            ...
            >
              ...
              <h4 className="text-[#515757] text-lg font-semibold mb-2">
                {t("praeventionLongevity.cgmTitle")}
              </h4>
              <p className="text-[#515757]/60 text-sm leading-relaxed">
                {t("praeventionLongevity.cgmDesc")}
              </p>
            </div>
          </div>
      ...
      <section
        ref={systemAnim.ref}
        style={systemAnim.style}
        className="pt-16 sm:pt-24 px-5 sm:px-10"
      >
        <div className="w-full max-w-7xl mx-auto">
          <h2
            className="text-[#43A9AB] font-black leading-[0.85] tracking-tighter text-left mb-6"
      ...
      {/* Diagnostik mit Sinn */}
      <section
        ref={diagnostikAnim.ref}
        style={diagnostikAnim.style}
        className="py-16 sm:py-24 px-5 sm:px-8"
      >
        <div className="max-w-4xl mx-auto">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <svg
                      className={`w-3 h-3 text-[#43a9ab] flex-shrink-0 transition-transform duration-300 ${
                        isOpen ? "rotate-90" : ""
                      }`}
                      fill="none"
                      stroke="currentColor"
      ...
      <section
        ref={startAnim.ref}
        style={startAnim.style}
        className="py-16 sm:py-24 px-5 sm:px-8"
      >
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#43A9AB] mb-12 tracking-tight">
            {t("praeventionLongevity.startTitle")}
          </h2>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#43A9AB] mb-8 tracking-tight">
            {t("praeventionLongevity.fitTitle")}
          </h2>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#43A9AB] mb-10 tracking-tight">
            {t("praeventionLongevity.faqTitle")}
          </h2>
