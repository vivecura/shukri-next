...
import { fetchAllPostsGrouped } from "@/lib/blogQueries.client";
import { TOPICS, getTopicLabel } from "@/lib/topics";

// Blog management panel. Lists DE/EN paired blog posts, supports edit
// metadata, toggle publish/feature/pin, assign topics, delete.
// Extracted from legacy CRA Admin.js — kept as a standalone client panel.
