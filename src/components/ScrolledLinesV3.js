...
function ScrolledLinesV3({ lines: linesProp }) {
  ...
  const lines = linesProp || dict?.scrolledLinesV3?.lines || DICTS.de.scrolledLinesV3.lines;
  const redWords = dict?.scrolledLinesV3?.redWords || DICTS.de.scrolledLinesV3.redWords;
  const greenWords = dict?.scrolledLinesV3?.greenWords || DICTS.de.scrolledLinesV3.greenWords;
