...
const ServicesCardssmaller2 = () => {
  ...
  // Direct dict access for object/array translations
  const dict = DICTS[lang] || DICTS.de;
  const cardsDict = dict?.infusions?.cards || DICTS.de.infusions.cards;

  const cards = cardLayout.map((c) => {
    const data = cardsDict[c.key] || {};
    return {
      ...c,
      bg: "bg-white",
      title: data.title,
  ...
  return (
    <div
      ref={sectionRef}
      className="relative flex flex-col justify-center items-center bg-white max-w-screen min-h-[60vh] pt-0 pb-16"
            ...
            >
              ...
              <div className="relative z-10 flex flex-col w-full h-full">
                ...
                <div className="flex flex-col flex-1 px-4 pt-3 pb-4">
                  <h2 className="font-semibold text-base md:text-lg text-[#515757] text-left">
                    {card.title}
                  </h2>
              ...
              <div className="px-6 pt-5 pb-4">
                ...
                <div className="mb-5">
                  ...
                  <p className="text-sm text-[#515757]/60 leading-relaxed">
                    {cards[expandedIndex].ingredients}
                  </p>
                </div>
